...
vulkan_enable = true
# 是否启用 Fun-ASR-Nano-GGUF-2026-02-06 模型 Vulkan 加速 GPU 推理

vulkan_force_fp32 = false
# 是否强制 Fun-ASR-Nano-GGUF-2026-02-06 模型 FP32 计算（如果 GPU 是 Intel 集显且出现精度溢出，可设为 true）

expand_funasr_hotwords = false
# 是否启用 Fun-ASR-Nano-GGUF-2026-02-06 模型热词扩展功能
...
funasr_dir = "models/Fun-ASR-Nano-GGUF-2026-02-06"
# FunASR 路径

funasr_encoder_adaptor_path = "models/Fun-ASR-Nano-GGUF-2026-02-06/model/Fun-ASR-Nano-Encoder-Adaptor.fp16.onnx"
# FunASR encoder_adaptor 模型路径

funasr_ctc_path = "models/Fun-ASR-Nano-GGUF-2026-02-06/model/Fun-ASR-Nano-CTC.fp16.onnx"
# CTC 快速预识别

funasr_llm_path = "models/Fun-ASR-Nano-GGUF-2026-02-06/model/Fun-ASR-Nano-Decoder.q8_0.gguf"
# FunASR llm 模型路径

funasr_tokens_path = "models/Fun-ASR-Nano-GGUF-2026-02-06/model/tokens.txt"
# FunASR tokens 路径

funasr_hotwords_path = "models/Fun-ASR-Nano-GGUF-2026-02-06/hot.txt"
# FunASR 热词文件路径
