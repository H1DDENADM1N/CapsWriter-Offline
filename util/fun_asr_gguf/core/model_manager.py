    ...
    def initialize(self, verbose: bool = True) -> bool:
        ...
        try:
            ...
            self.encoder_sess, self.ctc_sess, _ = load_onnx_models(
                encoder_path=self.config.encoder_onnx_path,
                ctc_path=self.config.ctc_onnx_path,
                directml_enable=self.config.directml_enable,
                logger=self.logger,
            )
