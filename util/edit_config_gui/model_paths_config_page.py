            ...
            if not self.funasr_encoder_adaptor_path:
                try:
                    SiGlobal.siui.windows[
                        ...
                        text="已恢复默认值：models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Encoder-Adaptor.int8.onnx",
                        msg_type=3,
                        icon=SiGlobal.siui.iconpack.get("ic_fluent_warning_regular"),
                        fold_after=5000,
                    )
                ...
                self.funasr_encoder_adaptor_path_selector.path_input.lineEdit().setText(
                    "models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Encoder-Adaptor.int8.onnx"
                )
                self.funasr_encoder_adaptor_path = "models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Encoder-Adaptor.int8.onnx"
            ...
            if not self.funasr_ctc_path:
                try:
                    SiGlobal.siui.windows[
                        ...
                        text="已恢复默认值：models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-CTC.int8.onnx",
                        msg_type=3,
                        icon=SiGlobal.siui.iconpack.get("ic_fluent_warning_regular"),
                        fold_after=5000,
                    )
                ...
                self.funasr_ctc_path_selector.path_input.lineEdit().setText(
                    "models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-CTC.int8.onnx"
                )
                self.funasr_ctc_path = "models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-CTC.int8.onnx"
            ...
            if not self.funasr_llm_path:
                try:
                    SiGlobal.siui.windows[
                        ...
                        text="已恢复默认值：models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Decoder.q8_0.gguf",
                        msg_type=3,
                        icon=SiGlobal.siui.iconpack.get("ic_fluent_warning_regular"),
                        fold_after=5000,
                    )
                ...
                self.funasr_llm_path_selector.path_input.lineEdit().setText(
                    "models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Decoder.q8_0.gguf"
                )
                self.funasr_llm_path = "models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Decoder.q8_0.gguf"
            ...
            if not self.funasr_tokens_path:
                try:
                    SiGlobal.siui.windows[
                        ...
                        text="已恢复默认值：models/Fun-ASR-Nano-GGUF-2026-02-09/model/tokens.txt",
                        msg_type=3,
                        icon=SiGlobal.siui.iconpack.get("ic_fluent_warning_regular"),
                        fold_after=5000,
                    )
                ...
                self.funasr_tokens_path_selector.path_input.lineEdit().setText(
                    "models/Fun-ASR-Nano-GGUF-2026-02-09/model/tokens.txt"
                )
            ...
            if not self.funasr_hotwords_path:
                try:
                    SiGlobal.siui.windows[
                        ...
                        text="已恢复默认值：models/Fun-ASR-Nano-GGUF-2026-02-09/hot.txt",
                        msg_type=3,
                        icon=SiGlobal.siui.iconpack.get("ic_fluent_warning_regular"),
                        fold_after=5000,
                    )
    ...
    def init_ui(self):
        ...
        with self.titled_widgets_group as group:
            ...
            self.funasr_encoder_adaptor_path_selector = SelectPath(
                ...
                label_text='默认值："models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Encoder-Adaptor.int8.onnx"',
            ...
            self.funasr_ctc_path_selector = SelectPath(
                ...
                label_text='默认值："models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-CTC.fp32.onnx"',
            ...
            self.funasr_llm_path_selector = SelectPath(
                ...
                label_text='默认值："models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Decoder.q8_0.gguf"',
            ...
            self.funasr_tokens_path_selector = SelectPath(
                ...
                label_text='默认值："models/Fun-ASR-Nano-GGUF-2026-02-09/model/Fun-ASR-Nano-Tokens.txt"',
            ...
            self.funasr_hotwords_path_selector = SelectPath(
                self,
                title="FunASR 热词文件路径",
                label_text='默认值："models/Fun-ASR-Nano-GGUF-2026-02-09/hot.txt"',
